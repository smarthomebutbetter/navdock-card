  ...
  _styles(maxWidth, bottom) {
    return `
      ...
      *, *::before, *::after { box-sizing:border-box; }
      ...
      .mobile.floating{bottom:calc(26px + env(safe-area-inset-bottom));width:min(calc(100vw - 56px),400px);--nd-height:76px}
      ...
      .stack.mobile-sheet{position:fixed;bottom:0;left:50%;transform:translateX(-50%);z-index:99;flex-direction:column;gap:0;pointer-events:auto;height:100dvh;overflow:hidden}
      .stack.mobile-sheet .dock{position:fixed;bottom:0;left:50%;transform:translateX(-50%);z-index:100}
      .stack.mobile-sheet .expanded,.stack.mobile-sheet .profile-panel{position:fixed;bottom:calc(var(--nd-height) + 26px + env(safe-area-inset-bottom));left:50%;transform:translateX(-50%);width:calc(100vw - 24px);max-height:calc(100dvh - var(--nd-height) - 26px - env(safe-area-inset-top) - env(safe-area-inset-bottom) - 20px);border:1px solid var(--nd-border);box-shadow:var(--nd-shadow,0 0 0 1px rgba(255,255,255,.075),0 14px 42px rgba(0,0,0,.38),0 3px 10px rgba(0,0,0,.24));border-radius:var(--nd-radius);animation:nd-sheet .25s cubic-bezier(.2,.8,.2,1);transform-origin:bottom center;padding:16px;overflow:auto;z-index:101}
      ...
      .expanded { width:min(calc(100vw - 24px),var(--nd-panel-width));min-height:390px;align-self:center;border-radius:var(--nd-radius); padding:24px; animation:nd-sheet .25s cubic-bezier(.2,.8,.2,1); transform-origin:bottom center;display:flex;flex-direction:column;justify-content:space-between;touch-action:pan-y;position:relative; }
      ...
      .profile-panel{border-radius:var(--nd-radius);padding:16px;animation:nd-sheet .25s cubic-bezier(.2,.8,.2,1);transform-origin:bottom center;max-height:min(560px,calc(100vh - 120px));overflow:auto;position:relative}
